...
TEST(mRNAReaderTester, open_simple_fasta_file)
{
    ...
    reader.loadmRNAFile("/mnt/Projects/Gillespie_Cpp/data/mRNAs/MaxCFLuc.txt");
...
TEST(mRNAReaderTester, open_fasta_file_one_gene_with_header) {
    ...
    mRNA_utils::mRNAReader reader;
    reader.loadmRNAFile("/mnt/Projects/Gillespie_Cpp/data/mRNAs/RTN3.txt");
    ...
    reader.loadmRNAFile("/mnt/Projects/Gillespie_Cpp/data/mRNAs/Saccharomyces_cerevisiae.R64-1-1.cdna.all.fa");
...
TEST(mRNAReaderTester, open_fasta_file_many_genes_with_header) {
    //Test to read file with only one DNA sequence with header.
    mRNA_utils::mRNAReader reader;
    const std::string fasta_file = "/mnt/Projects/Gillespie_Cpp/data/mRNAs/Saccharomyces_cerevisiae.R64-1-1.cdna.all.fa";
